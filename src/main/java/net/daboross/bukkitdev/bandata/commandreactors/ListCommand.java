...
public class ListCommand extends SubCommand {
    ...
    public ListCommand(BanDataPlugin plugin) {
        super("list", new String[]{"l"}, true, "bandata.listbans", new String[]{"PageNumber"}, "This Command Lists All Players Who Have Been Banned and How Many Times They have Been Banned");
        this.plugin = plugin;
    }
